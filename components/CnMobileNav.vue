    ...
    <div class="mdui-color-deep-orange-accent mdui-text-color-white">
      ...
      <div class="mdui-drawer mdui-drawer-left mdui-text-color-black-text" id="main-drawer">
        <ul class="mdui-list">
          ...
          <a href="/mobile/zh-CN/mitools"><li class="mdui-list-item"><i class="mdui-list-item-icon mdui-icon material-icons">computer</i><div class="mdui-list-item-content">刷机工具</div></li></a>
