        ...
        <div class="mdui-panel-item mdui-panel-item-open">
          ...
          <div class="mdui-panel-item-body devnotice">
            <ol>
              ...
              <li v-show="roms.cbshow != ''"><b>内测申请：</b><span v-show="roms.csid.length > 0" v-for="(data) in roms.csid"><a :href="('https://web.vip.miui.com/page/info/mio/mio/testDetails?id=' + data)">正式版(稳定版)&emsp;</a></span><span v-show="roms.cbid.length > 0" v-for="(data) in roms.cbid"><a :href="('https://web.vip.miui.com/page/info/mio/mio/testDetails?id=' + data)">开发版&emsp;</a></span></li>
