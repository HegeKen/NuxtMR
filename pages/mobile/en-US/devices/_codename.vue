                ...
                <table class="mdui-table">
                  ...
                  <tbody>
                    <tr v-for="(data, index) in links">
                      ...
                      <td v-else><a :href="('https://airtel.bigota.d.miui.com/' + data.miui + '/' + data.recovery)">Recovery</a></td>
                      <td v-if="data.fastboot == ''">N/A</td>
                      <td v-else><a :href="('https://airtel.bigota.d.miui.com/' + data.miui + '/' + data.fastboot)">Fastboot</a></td>
                    </tr>
                  </tbody>
                </table>
              </div>
