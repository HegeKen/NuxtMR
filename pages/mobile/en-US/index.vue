          ...
          <div class="mdui-panel-item-body">
            ...
            <ul>
              <li>Mi Series：<span v-for="(data, index) in devices.mi">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.mi.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.mi.length - 1"> {{ data.enname }} </a>
                </span></li>
              <li>Mi SE Series：<span v-for="(data, index) in devices.mise">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.mise.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.mise.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Mi CC Series：<span v-for="(data, index) in devices.micc">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.micc.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.micc.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Mi Note Series：<span v-for="(data, index) in devices.minote">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.minote.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.minote.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Mi MAX Series：<span v-for="(data, index) in devices.mimax">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.mimax.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.mimax.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Mi MIX Series：<span v-for="(data, index) in devices.mimix">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.mimix.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.mimix.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Mi Pad Series：<span v-for="(data, index) in devices.mipad">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.mipad.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.mipad.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              ...
              <li>Mi A Series：<span v-for="(data, index) in devices.mia">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.mia.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.mia.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              ...
              <li>Redmi Note Series：<span v-for="(data, index) in devices.rmnote">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.rmnote.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.rmnote.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Redmi K Series：<span v-for="(data, index) in devices.rmk">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.rmk.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.rmk.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Redmi Pad：<span v-for="(data, index) in devices.rmpad">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.rmpad.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.rmpad.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>Other Redmi Phones：<span v-for="(data, index) in devices.rmothers">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.rmothers.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.rmothers.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>POCO C Series：<span v-for="(data, index) in devices.pococ">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.pococ.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.pococ.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>POCO F Series：<span v-for="(data, index) in devices.pocof">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.pocof.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.pocof.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>POCO M Series：<span v-for="(data, index) in devices.pocom">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.pocom.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.pocom.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
              <li>POCO X Series：<span v-for="(data, index) in devices.pocox">
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index != devices.pocox.length - 1"> {{ data.enname }} /</a>
                  <a :href="('/mobile/en-US/devices/' + data.code)" v-show="index == devices.pocox.length - 1"> {{ data.enname }} </a>
                </span>
              </li>
            </ul>
