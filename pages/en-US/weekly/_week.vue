        ...
        <table class="mdui-table">
          ...
          <tbody v-for="(data) in week.devices">
            <tr>
              ...
              <td v-else><a :href="('https://orig.bigota.d.miui.com/' + data.miui + '/' + data.recovery)">{{ data.recovery }}</a></td>
              <td v-if="data.fastboot == ''">N/A</td>
              <td v-else><a :href="('https://orig.bigota.d.miui.com/' + data.miui + '/' + data.fastboot)">{{ data.fastboot }}</a></td>
            </tr>
          </tbody>
        </table>
      </div>
