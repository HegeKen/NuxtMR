        ...
        <div class="mdui-panel-item mdui-panel-item-open">
          ...
          <div class="mdui-panel-item-body devnotice">
            <ol>
              ...
              <li v-show="roms.cbshow != ''"><b>Apply for test：</b><span v-show="roms.csid.length > 0" v-for="(data) in roms.csid"><a :href="('https://web.vip.miui.com/page/info/mio/mio/testDetails?id=' + data)">China Stable&emsp;</a></span><span v-show="roms.cbid.length > 0" v-for="(data) in roms.cbid"><a :href="('https://web.vip.miui.com/page/info/mio/mio/testDetails?id=' + data)">China Beta&emsp;</a></span>(View on Mobile Mode)</li>
